...
'''
# name_template = '{:0>3d}'#设置编号格式化为 3 位
...
for md in md_list:
    md_file = path + '\\' + md
    with open(md_file, 'r', encoding='utf-8',errors='ignore') as file: #此处忽略错误，可能导致某些格式无法支持，如 png
